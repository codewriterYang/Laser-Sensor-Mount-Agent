...
- **AI**：DeepSeek-V4-pro（文本生成）+ Doubao-Seedream-5.0-lite（图片生成）
- **前端**：Vanilla HTML/JS SPA
- **测试**：pytest（Contract + Unit + Integration + E2E）共 161 个
...
| `LLM_MODEL` | 文本模型 ID（ep-20260612171548-vl96m） | 否 |
| `IMAGE_API_KEY` | Seedream API Key（火山引擎） | 否（无则仅生成参考图） |
| `IMAGE_MODEL` | 图片模型 ID（ep-20260613220950-8m6pw） | 否 |
